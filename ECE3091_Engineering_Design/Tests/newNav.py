...
def motor_simulator():
    ...
    angular1 = (2*math.pi*(rotary1.steps-pre_steps1))/(stepsForFullTurn*0.02)*1.05
...
class TentaclePlanner:
    ...
    def __init__(self,dt=0.0214,steps=25,alpha=5,beta=0.1):
