...
class DiffDriveRobot:
    ...
    def __init__(self,inertia=5, dt=0.028, drag=0.2, wheel_radius=0.026, wheel_sep=0.102):
...
class TentaclePlanner:
    ...
    def __init__(self,dt=0.028,steps=15,alpha=5,beta=0):
    ...
    def plan(self,goal_x,goal_y,goal_th,x,y,th):
        ...
        distanceFront = 500#distance(GPIO_ECHO_FRONT)
        distanceLeft = 500#distance(GPIO_ECHO_LEFT)
        distanceRight = 500#distance(GPIO_ECHO_RIGHT)
